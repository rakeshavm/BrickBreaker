...
public class Gameplay4 extends JPanel implements KeyListener, ActionListener 
{
	...
	public Gameplay4(int x, int y, int d, Main m1)
	{		
		m = m1;
		xb=x;
		yb=y;
	...
	public int getHighScore()
	{
		...
		try 
		{
			reader = new BufferedReader(new FileReader("highscore4.dat"));
	...
	public void checkScore()
	{
		...
		if(score>highscore)
		{
			highscore=score;
			try {
				output = new BufferedWriter(new FileWriter("highscore4.dat"));
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(hit == 1) {
			...
			{	
				...
				if(new Rectangle(ballposX2, ballposY2, 15, 15).intersects(new Rectangle(playerX-30, 9*y/10, 60, 8)))
				{
					ballYdir2 = -ballYdir2;
					if(ballXdir2>0)
						ballXdir2 = -ballXdir2;
				}
				else if(new Rectangle(ballposX2, ballposY2, 15, 15).intersects(new Rectangle(playerX + 30, 9*y/10, 40, 8)))
				{
					ballYdir2 = -ballYdir2;

				}
				else if(new Rectangle(ballposX2, ballposY2, 15, 15).intersects(new Rectangle(playerX + 70, 9*y/10, 60, 8)))
				{
					ballYdir2 = -ballYdir2;
					if(ballXdir2<0)
						ballXdir2 = -ballXdir2;
