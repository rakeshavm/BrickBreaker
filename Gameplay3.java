...
public class Gameplay3 extends JPanel implements KeyListener, ActionListener 
{
	...
	public Gameplay3(int x, int y, int d, Main m1)
	{		
		m = m1;
		xb=x;
		yb=y;
	...
	public int getHighScore()
	{
		...
		try 
		{
			reader = new BufferedReader(new FileReader("highscore3.dat"));
	...
	public void checkScore()
	{
		...
		if(score>highscore)
		{
			highscore=score;
			try {
				output = new BufferedWriter(new FileWriter("highscore3.dat"));
